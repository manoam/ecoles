  ...
  <div id="footer">
    ...
    <?php if (!theme_get_setting('remove_copyright')): ?>
     <?php if (!theme_get_setting('copyright_override')): ?>
		...
		$base_cr_year = (!theme_get_setting('copyright_baseyear'))?date('Y'):theme_get_setting('copyright_baseyear');
		$cr_dates = ($base_cr_year == date('Y'))?$base_cr_year:"$base_cr_year - " . date('Y');
		print t('Copyright'); ?> &copy; <?php echo $cr_dates; ?>, <?php print check_plain(theme_get_setting('copyright_holder')) ?></p>     <?php else: ?>
