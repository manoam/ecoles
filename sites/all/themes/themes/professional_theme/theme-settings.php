...
function professional_theme_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  $form['prof_settings']['copyright_information']['copyright_override'] = array(
    ...
    '#description' => t('override the entire copyright line'),
  );
  $form['prof_settings']['copyright_information']['copyright_holder'] = array(
    ...
    '#description' => t('Name the copyright holder of the site that will be displayed in the footer'),
  );
  $form['prof_settings']['copyright_information']['copyright_baseyear'] = array(
    '#type' => 'textfield',
    '#title' => t('Copyright Base Year'),
    '#default_value' => theme_get_setting('copyright_baseyear'),
    '#description' => t('First year for the copyright line, so in subsequent years there will be range printed'),
  );
