 ...
 * - $is_admin: TRUE if the user has permission to main-menu admini_zymphonies_themestration pages.
 *
 * Site identity:
 ...
 *   menu admini_zymphonies_themestration interface.
...
<?php endif; ?>
  ...
  <?php if ($is_front): ?> 
    ...
    <?php if ($page['top_first'] || $page['top_second']): ?>
  ...
  <div id="container">
    <div class="wrap">
      <div class="content-sidebar-wrap">
        <div id="content">
          <?php if (theme_get_setting('breadcrumbs', 'mini_zymphonies_theme')): ?>
            <div id="breadcrumbs">
...
<div id="footer">
  ...
  <?php if (theme_get_setting('social_links', 'mini_zymphonies_theme')): ?>
    <span class="social-icons">
     <ul>
      <li><a class="fb" href="<?php echo theme_get_setting('facebook_profile_url', 'mini_zymphonies_theme'); ?>" target="_blank" rel="me"><i class="fa fa-facebook"></i></a></li>
      <li><a class="twitter" href="<?php echo theme_get_setting('twitter_profile_url', 'mini_zymphonies_theme'); ?>" target="_blank" rel="me"><i class="fa fa-twitter"></i></a></li>
      <li><a class="gplus" href="<?php echo theme_get_setting('gplus_profile_url', 'mini_zymphonies_theme'); ?>" target="_blank" rel="me"><i class="fa fa-google-plus"></i></a></li>
      <li><a class="linkedin" href="<?php echo theme_get_setting('linkedin_profile_url', 'mini_zymphonies_theme'); ?>" target="_blank" rel="me"><i class="fa fa-linkedin"></i></a></li>
      <li><a class="pinterest" href="<?php echo theme_get_setting('pinterest_profile_url', 'mini_zymphonies_theme'); ?>" target="_blank" rel="me"><i class="fa fa-pinterest"></i></a></li>
      <li><a class="youtube" href="<?php echo theme_get_setting('youtube_profile_url', 'mini_zymphonies_theme'); ?>" target="_blank" rel="me"><i class="fa fa-youtube"></i></a></li>
  ...
  <div class="footer_credit">
    ...
    <div id="copyright" class="wrap clearfix">
      ...
      <p class="credits"> <?php print t('Designed by '); ?><?php print $site_name; ?></p></p>
    </div>
  </div>
